...
public class TestConfig{
	...
	public static String from = "kshitij.gameon@gmail.com";
	public static String password = "Hobner@29";
	public static String[] to ={"kshitij.gameon@gmail.com","kshitij.gameon@gmail.com"};
